...
Explain things in life as existing in hierarchies.
Mirror this fact with hierarchies in layout to justify your explanation for knowledge mapping.

Filling Bottles
Type systems and polymorphism - parameters (refer to the bottle analogy)

- a context is defined by constraints and affordances.
